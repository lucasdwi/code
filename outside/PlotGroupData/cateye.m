...
for i = 1:n
    ...
    scatter(x(i), median(Y(:,i)), 80, 'o', 'markeredgecolor', (col(i,:)+[0 0 0])/2, 'markerfacecolor', (col(i,:)+[0 0 0])/2, 'linewidth', wid); % Plot median
    scatter(x(i), mean(Y(:,i)), 120, '*', 'markeredgecolor', (col(i,:)+[0 0 0])/2, 'linewidth', wid); % Plot mean
end
hold off
